...
if old not in text:
    raise SystemExit(
        "ERROR: Current Historical Data asymmetric x-axis block not found; no changes written."
    )
...
print(
    "SUCCESS: Historical Data visible x-axis now matches the selected range exactly."
)
